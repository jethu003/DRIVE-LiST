        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              ...
              // Fields
              _buildField(_modelCtrl, 'Vehicle Model',
                  Icons.directions_car_outlined,
                  hint: 'e.g. Swift, Creta, Nexon'),
              _buildField(_colorCtrl, 'Color', Icons.palette_outlined,
                  hint: 'e.g. Pearl White, Midnight Blue'),
              _buildField(_wheelCtrl, 'Wheel Type', Icons.tire_repair_outlined,
                  hint: 'e.g. Alloy, Steel, Performance'),
              _buildField(
                  _yearCtrl, 'Manufacturing Year',
        ...
        child: Obx(() {
              ...
              children: [
                ...
                Positioned(
                  ...
                  child: Container(
                    ...
                    child: Text(
                      _uploadedUrl != null ? '✓ Uploaded' : '⚠ Failed',
          ...
          return Column(
            ...
            children: [
              ...
              const Text('Tap to pick vehicle image',
                  style: TextStyle(
                      color: AppColors.textMuted,
                      fontWeight: FontWeight.w500)),
              const SizedBox(height: 4),
              Text('Uploads to Cloudinary automatically',
                  style: TextStyle(
